...
namespace Freedom.Utility.Cryptography.Implement
{
    public class Encryption : IEncryption
    {
        private readonly string _secureKey = "doisFilhos";
        ...
        {
            string encrypText = _securityController.Encrypt(_secureKey, data);
            return encrypText;
        }

        public string DecryptString(string encryptedText)
        {
            string notEncrypText = _securityController.Decrypt(_secureKey, encryptedText);
            return notEncrypText;
        }
    }
