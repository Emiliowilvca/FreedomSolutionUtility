...
{
    public class BankExtractionRequestBind : BindableBase
    {
        ...
        private string _checkNumberSince;
        private string _checkNumberUntil;
        ...
        public string CheckNumberSince { get => _checkNumberSince; set => SetProperty(ref _checkNumberSince, value); }

        public string CheckNumberUntil { get => _checkNumberUntil; set => SetProperty(ref _checkNumberUntil, value); }
    }
}